...
board_1 = %Sq2.Board{game_id: game.id, name: "The Beginning", type: "anarchy", slug: Sq2.SeedsHelper.get_slug("The Beginning")}
...
board_3_role_1 = %Sq2.Role{board_id: board_2.id, name: "citizen"}
